...
namespace Jeomseon.Unity.GridTileSystem.Tests
{
    public sealed class HexTileSelectionStateTests
    {
        ...
        {
            global::Jeomseon.Unity.GridTileSystem.HexTile first = new(0, 0);
            global::Jeomseon.Unity.GridTileSystem.HexTile second = new(1, 0);
